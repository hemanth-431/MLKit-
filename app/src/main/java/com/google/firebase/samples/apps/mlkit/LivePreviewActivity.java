...
button=findViewById(R.id.selectq);
    button.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent i=new Intent(LivePreviewActivity.this,select.class);
            startActivity(i);
        }
    });
...
if(message == null){
  ...
  public synchronized void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
    ...
    selectedModel = message;
      ...
      Toast.makeText(LivePreviewActivity.this,selectedModel,Toast.LENGTH_LONG).show();
